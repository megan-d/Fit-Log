        ...
        <form className="form contact-form" action="">
          <div className="form-container">
            <div className="form-group">
              <label>What is your current weight in pounds?
            ...
            <div className="form-group">
              <label>What is your goal weight in pounds?
              <input type="number" name="goal-weight" placeholder="" required />
              </label>
            </div>
            <div className="form-group">
              <label>What is your daily calorie goal? If unsure, 2000 is a starting point.
              <input type="number" name="calories" placeholder="" required />
              </label>
            </div>
            <div className="form-group">
              <label>How many days per week is your exercise goal?
