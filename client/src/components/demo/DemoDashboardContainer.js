...
import { getDemoUserProfile, deleteUser } from '../../actions/profile';
...
DashboardContainer.propTypes = {
  getDemoUserProfile: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getDemoUserProfile, deleteUser })(
  DashboardContainer,
);
